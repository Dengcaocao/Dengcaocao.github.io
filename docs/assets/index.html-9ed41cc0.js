...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="v8-引擎的垃圾回收" tabindex="-1"><a class="header-anchor" href="#v8-引擎的垃圾回收" aria-hidden="true">#</a> V8 引擎的垃圾回收</h2><h2 id="performance-工具" tabindex="-1"><a class="header-anchor" href="#performance-工具" aria-hidden="true">#</a> performance 工具</h2><h2 id="优化实例" tabindex="-1"><a class="header-anchor" href="#优化实例" aria-hidden="true">#</a> 优化实例</h2>`,15),o=[p];function c(i,l){return s(),a("div",null,o)}const u=n(t,[["render",c],["__file","index.html.vue"]]);export{u as default};
