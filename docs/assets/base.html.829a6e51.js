import{ab as t,A as l,B as i,z as n,M as s,H as p,ad as a,O as o}from"./framework.43ef2d2f.js";const c={},r=a(`<p><code>webpack</code> 是一个<strong>静态资源打包工具</strong>。以一个或多个文件作为打包入口，将项目所有的依赖文件编译成一个或多个文件输出。</p><p><code>webpack</code> 只能处理 js 文件，处理其他文件需要其他依赖包。</p><h2 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h2><ol><li>下载依赖</li></ol><ul><li>初始化包文件</li></ul><div class="language-npm line-numbers-mode" data-ext="npm"><pre class="language-npm"><code>  npm init -y
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19);function _(q,E){const e=o("ExternalLinkIcon");return l(),i("div",null,[r,n("p",null,[s("在处理 css、sass、less、scss、styl 样式时需要借助官方 "),n("a",d,[s("loader"),p(e)]),s(" 处理才能进行打包。")]),u,n("p",null,[s("webpack5 已经内置了 "),v,s("，只需要进行简单的 "),n("a",k,[s("配置"),p(e)]),s(" 就能处理图片资源。")]),m,n("ul",null,[b,n("li",null,[n("p",null,[n("a",g,[s("笔记文档"),p(e)])])]),n("li",null,[n("p",null,[n("a",h,[s("官网配置规则"),p(e)])])])]),y,n("h2",x,[j,s(" 区分开发和生产"),n("a",f,[s("配置文件"),p(e)])]),w])}const C=t(c,[["render",_],["__file","base.html.vue"]]);export{C as default};
