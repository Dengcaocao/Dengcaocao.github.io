import{_ as t,V as l,W as i,$ as n,a1 as s,Y as p,Z as a,y as o}from"./framework.1721950b.js";const c={},r=a(`<p><code>webpack</code> 是一个<strong>静态资源打包工具</strong>。以一个或多个文件作为打包入口，将项目所有的依赖文件编译成一个或多个文件输出。</p><p><code>webpack</code> 只能处理 js 文件，处理其他文件需要其他依赖包。</p><h2 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h2><ol><li>下载依赖</li></ol><ul><li>初始化包文件</li></ul><div class="language-npm line-numbers-mode" data-ext="npm"><pre class="language-npm"><code>  npm init -y
